  ...
  return (<>
    ...
    >
      ...
      >
        ...
        <Flex style={{ marginTop: '100px' }} justify='space-around' w={['70%', '30%', '20%']}>
          <Button
            borderRadius='full'
            color='white'
          ...
          <Button href='/login' as={Link} borderRadius='full' colorScheme='teal' size='lg' fontWeight='bold'>
            Log in
          </Button>
        </Flex>

        <VStack color='white' bottom={5} position='absolute' _hover={{ textDecoration: 'none' }} href='#more' as={Link} cursor='pointer'>
          <Text position='relative' top={2} >learn more</Text>
